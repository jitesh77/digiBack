...
dps.getInfo(function(res: any, err: any) {
...
dps.IsValidPubKey(
  "DLGrXhJ31TjYYx6yLFGnj6f4SqP1sp9cer",
  "03000151e795f9827cc21682b9bb6d00db1ed6e1d198057cdb15b4c146e854dd32",
...
dps.createMultisig(
  ...
  function(res: any, err: any) {
    if (err == undefined) {
      console.log(
        "Store multisig Address %s and redeemScript %s",
        res.address,
        res.redeemScript
      );
    } else {
